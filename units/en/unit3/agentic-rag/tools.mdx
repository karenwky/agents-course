...
<details>
<summary>Install the DuckDuckGo Toolspec</summary>
As introduced in the <a href="../../unit2/llama-index/tools">section on the LlamaHub</a>, we can install the DuckDuckGo toolspec with the following command:
